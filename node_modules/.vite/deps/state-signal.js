// node_modules/.pnpm/state-signal@0.0.3_@types+node@22.10.1/node_modules/state-signal/dist/index.es.js
var c = [];
...
function g(t, e = {}) {
  const { history: s = true, maxHistory: a = 10 } = e;
  let l = t;
  ...
  return {
    ...
    set value(r) {
      if (l !== r) {
        ...
        for (const i of f)
          o ? u.add(i) : i();
        o || (o = true, Promise.resolve().then(d));
      }
    },
    /**
